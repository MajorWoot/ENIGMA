...
class Enigma:
    ...
    # going to need a loop to go over all the letters in string
    # eventualy need to count number of letters for rotation and rotation of other rotors
    def full_passthrough(self):
        ...
        for i in letter:
            ...
            # step0 = Rotor(self.rotor_1, i,  )
            # step1 = Rotor(self.rotor_1, i)
            # step2 = Rotor(self.rotor_2, step1.rotor())
            # step3 = Rotor(self.rotor_3, step2.rotor())
            # step4 = Reflector(self.reflector, step3.rotor())
            # step5 = Rotor(self.rotor_3, step4.reflect())         # YES IM SURE THERES A BETTER WAY... Found the better way.... 
            # step6 = Rotor(self.rotor_2, step5.back_rotor())      # i will leave this here as a remnants of my own stupidity
            # step7 = Rotor(self.rotor_1, step6.back_rotor())
            # encrypted += step7.back_rotor()
...
class Rotor:
    ...
    # easier to split the function of reflecting and rotors.
    # def reflector(self):
    #     index = self._alphabet.find(self.letter)
    #     return self.rotor_str[index]
...
class Switchboard:
    ...
    def __init__(self, input_string, switch_dict): # Switch dict is second argument because there could be none.
...
def user_input():
    ...
    if option == 1:
        ...
        return default_enigma()
        
    elif option == 2:

        return custom_enigma()
...
def main():
    ...
    banner()
    print(f"Encrypted/Decrypted string:\n{user_input()}")
